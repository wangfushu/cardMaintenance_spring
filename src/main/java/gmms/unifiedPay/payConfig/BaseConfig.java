...
public class BaseConfig {
      //
      //
      //public  static String  appId = "201701220001";       //统一支付平台颁发给源系统的唯一标识，为应用标识字段   测试
      //public static String secret = "xmrbi3967968@2017";      //测试


      public  static String  appId = "201805100002";       //统一支付平台颁发给源系统的唯一标识，为应用标识字段   正式
      public static String secret = "ARKwh$C&omLR8#HvK1xHPGjxuJMoEGY5";      //正式
