...
<head>
    ...
    <title>发卡信息跨日报表</title>
</head>
<script type="text/javascript"></script>
<body>
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 报表管理 <span
        class="c-gray en">&gt;</span> 发卡信息跨日报表 <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px"
                                              href="javascript:location.replace(location.href);" title="刷新"><i
        class="Hui-iconfont">&#xe68f;</i></a></nav>
<div class="text-c" style="margin: 10px">
    <form id="issuetagday-list-form" action="${absoluteContextPath}/statistic/issuetag-day-report" method="post">
...
<script type="text/javascript">
    ...
    $(function () {
    var data = $("#issuetagday-list-form").serializeObject();
    $('.table-sort').dataTable({
        ...
        "searching": false,
        "ajax": {
            "url": "${absoluteContextPath}/statistic/issueTagDay",
            "data": data
        },
        "columns": [
            {"data" : null} ,
    ...
    function export_excel() {
        ...
        window.location.href = "${absoluteContextPath}/statistic/issueTagDayexport" + param;
    }
