...
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 报表管理 <span
        class="c-gray en">&gt;</span> 发卡信息年报表 <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px"
                                              href="javascript:location.replace(location.href);" title="刷新"><i
        class="Hui-iconfont">&#xe68f;</i></a></nav>
<div class="text-c" style="margin: 10px">
    <form id="issuetagyear-list-form" action="${absoluteContextPath}/statistic/issuetag-year-report" method="post">
...
<#--
       ...
       <#list plazaList as plaza>
        ...
        <span>年份</span>
        <input id="logmin" name="year" type="text"  value="${param.year!''}"  runat="server"  onfocus="WdatePicker({skin:'default',dateFmt:'yyyy'})"  class="input-text Wdate" style="width:120px;"/>
...
<script type="text/javascript">
    ...
    $(function () {
    var data = $("#issuetagyear-list-form").serializeObject();
    $('.table-sort').dataTable({
        ...
        "searching": false,
        "ajax": {
            "url": "${absoluteContextPath}/statistic/issueTagYear",
            "data": data
        },
        "columns": [
            {"data" : null} ,
