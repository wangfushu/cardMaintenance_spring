...
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 报表管理 <span
        class="c-gray en">&gt;</span> 二维卡出库报表 <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px"
                                              href="javascript:location.replace(location.href);" title="刷新"><i
        class="Hui-iconfont">&#xe68f;</i></a></nav>
<div class="text-c" style="margin: 10px">
    <form id="tagoutstore-list-form" action="${absoluteContextPath}/statistic/tagoutstore-report" method="post">
...
<script type="text/javascript">
    ...
    $(function () {
    var data = $("#tagoutstore-list-form").serializeObject();
    $('.table-sort').dataTable({
        ...
        "searching": false,
        "ajax": {
            "url": "${absoluteContextPath}/statistic/tagOutStore",
            "data": data
        },
        "columns": [
            {"data" : null} ,
            {"data": "outRecievedPlazaName"},
            {"data": "outSendPlazaName"},
            {"targets": 4,
                "data": "outStoreTime",
                "width": "100px",
                "defaultContent": "",
